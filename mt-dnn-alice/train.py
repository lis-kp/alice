...
from module.utils import boolean_string, none_string
...
def train_config(parser):
    ...
    parser.add_argument('--mean_teacher_alpha2',
        ...
        type=float,
        help="False (default), moving average parameter of mean teacher  (for the exponential moving average).")
    parser.add_argument('--mt_kd_tau', type=float, default=1,
                        help='mean knowledge distilation temperature')

    ## Virtual Adversarial Training
    parser.add_argument('--virtual_teacher',
        action='store_true',
    ...
    parser.add_argument('--vat_max_layer',
        default=-1,
        type=int,
        help="-1: embedding, other layers.")
    parser.add_argument('--vat_opt',
        default=0,
        type=int,
        help="0: only select layer; 1 sample")
    parser.add_argument('--vat_lambda',
        default=1,
        type=float,
        help="1 (default), trade off parameter for virtual adversarial training.")
    parser.add_argument('--vat_alpha', type=float, default=1)
    parser.add_argument('--vat_nosiy',
        default=1e-5,
        type=float)
    ## Use Noisy Copy
    ...
    parser.add_argument('--vat_stable_eps',
        default=1e-6,
        type=float,
        help="1e-3 (default), eps for adversarial copy training.")
    return parser
