...
prefix="dvdall_hanashidur_disc_0"
BATCH_SIZE=16
GRAD_ACC_STEPS=2
gpu=5,6
...
train_datasets="dvdppf,dvdduration,dvdorder,hanashiduration,disc"
#train_datasets="dct,t2e,e2e,mat"
test_datasets="dvdppf,dvdduration,dvdorder,hanashiduration,disc"
...
DATA_DIR="../../../dvd_hanashi/dvd_hanashi_all/0/"
...
python ../../../train.py  --epochs 10  --task_def ../../../experiments/dvd_hanashi/dvd_hanashi_task_def.yml --data_dir ${DATA_DIR} --multi_gpu_on  --init_checkpoint ${BERT_PATH} --batch_size ${BATCH_SIZE} --output_dir ${model_dir} --log_file ${log_file} --answer_opt ${answer_opt} --optimizer ${optim} --train_datasets ${train_datasets} --test_datasets ${test_datasets} --grad_clipping ${grad_clipping} --global_grad_clipping ${global_grad_clipping} --learning_rate ${lr}
