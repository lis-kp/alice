...
train_datasets="dvdppf,dvdduration,dvdorder,disc"
#train_datasets="dct,t2e,e2e,mat"
test_datasets="dvdppf,dvdduration,dvdorder,disc"
...
DATA_DIR="../../../dvd_hanashi/dvd_hanashi_all/4/"
